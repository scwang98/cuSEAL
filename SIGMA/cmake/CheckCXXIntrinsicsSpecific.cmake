...
if(SIGMA_USE_INTRIN)
    ...
    if(MSVC)
        ...
        check_cxx_source_runs("
            ...
            SIGMA__BITSCANREVERSE64_FOUND
        )
    else()
        # Check for presence of __int128
        set(CMAKE_EXTRA_INCLUDE_FILES ${SIGMA_INTRIN_HEADER})
        check_type_size("__int128" INT128 LANGUAGE CXX)
        if(INT128 EQUAL 16)
            set(SIGMA___INT128_FOUND ON)
        else()
            set(SIGMA___INT128_FOUND OFF)
        endif()
