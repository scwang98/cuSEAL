...
namespace SIGMANetTest
{
    ...
    public class EncryptionParameterQualifiersTests
    {
        ...
        public void PropertiesTest()
        {
            ...
            SIGMAContext context2 = new SIGMAContext(parms);
            ...
            SIGMAContext context3 = GlobalContext.BGVContext;
        ...
        public void BFVParameterErrorTest()
        {
            ...
            context = new SIGMAContext(encParam, expandModChain: true, secLevel: SecLevelType.None);
