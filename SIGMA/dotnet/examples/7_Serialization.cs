        ...
        */
        private static void ExampleSerialization()
        {
            ...
            */
            {
                ...
                */
                ...
                using SIGMAContext context = new SIGMAContext(parms);
            ...
            */
            ...
            SIGMAHeader struct, as defined in dotnet/src/Serialization.cs, and is
            followed by the possibly compressed data for the object.

            A SIGMAHeader contains the following data:

                [offset 0] 2-byte magic number 0xA15E (Serialization.SIGMAMagic)
            ...
            */
            Serialization.SIGMAHeader header = new Serialization.SIGMAHeader();
            ...
            */
            ...
            Console.Write("             ");
            Console.WriteLine($"Size indicated in SIGMAHeader: {header.Size} bytes");
            Console.WriteLine();
        }
    }
}
