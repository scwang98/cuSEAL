    ...
    partial class Examples
    {
        private static void ExampleBFVBasics()
        {
            ...
            */
            ...
            These numbers can also be found in native/src/sigma/util/hestdparms.h encoded
            in the function SIGMA_HE_STD_PARMS_128_TC, and can also be obtained from the
            function
            ...
            Microsoft SIGMA comes with helper functions for selecting the CoeffModulus.
            ...
            */
            ...
            /*
            Now that all parameters are set, we are ready to construct a SIGMAContext
            ...
            the Microsoft SIGMA memory pool, speeding up further allocations. Another way
            ...
            */
            ...
            /*
            When parameters are used to create SIGMAContext, Microsoft SIGMA will first
            ...
            */
            ...
            /*
            The encryption schemes in Microsoft SIGMA are public key encryption schemes.
            ...
            */
            ...
            possible to use Microsoft SIGMA in secret-key mode by providing the Encryptor
            ...
            */
            ...
            /*
            In Microsoft SIGMA, a valid ciphertext consists of two or more polynomials
            ...
            */
            ...
            /*
            When using Microsoft SIGMA, it is typically advantageous to compute in a way
            ...
            */
            ...
            Microsoft SIGMA can interpret the reason why parameters are considered invalid.
            ...
            */
            ...
            using SIGMAContext new_context = new SIGMAContext(parms);
            Utilities.PrintParameters(context);
