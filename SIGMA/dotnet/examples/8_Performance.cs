...
namespace SIGMANetExamples
{
    ...
    {
        private static void BFVPerformanceTest(SIGMAContext context)
        {
            Stopwatch timer;
        ...
        private static void CKKSPerformanceTest(SIGMAContext context)
        {
            Stopwatch timer;
            Utilities.PrintParameters(context);
            Console.WriteLine();
        ...
        private static void BGVPerformanceTest(SIGMAContext context)
        {
            Stopwatch timer;
            Utilities.PrintParameters(context);
            Console.WriteLine();
