        ...
        */
        private static void ExampleBatchEncoder()
        {
            ...
            */
            ...
            congruent to 1 modulo 2*PolyModulusDegree. Microsoft SIGMA provides a helper
            ...
            */
            ...
            parameter qualifiers created by SIGMAContext.
            */
        ...
        static private void ExampleCKKSEncoder()
        {
            ...
            */
            ...
            /*
            We create the SIGMAContext as usual and print the parameters.
            */
            using SIGMAContext context = new SIGMAContext(parms);
            Utilities.PrintParameters(context);
            Console.WriteLine();
