...
namespace SIGMANetExamples
{
    partial class Examples
    {
        private static void ExampleLevels()
        {
            ...
            related objects that represent them in Microsoft SIGMA.

            In Microsoft SIGMA a set of encryption parameters (excluding the random number
            ...
            When a SIGMAContext is created from a given EncryptionParameters instance,
            Microsoft SIGMA automatically creates a so-called `modulus switching chain',
            ...
            when the SIGMAContext is created, and stored in a SIGMAContext.ContextData
            object. The chain is basically a linked list of SIGMAContext.ContextData
            objects, and can easily be accessed through the SIGMAContext at any time. Each
            ...
            */
            ...
            /*
            There are convenience method for accessing the SIGMAContext.ContextData for
            some of the most important levels:

                SIGMAContext.KeyContextData: access to key level ContextData
                SIGMAContext.FirstContextData: access to highest data level ContextData
                SIGMAContext.LastContextData: access to lowest level ContextData
            ...
            */
            SIGMAContext.ContextData contextData = context.KeyContextData;
            ...
            */
            ...
            levels. This can be done by passing a bool `false' to SIGMAContext constructor.
            */
            using SIGMAContext context2 = new SIGMAContext(parms, expandModChain: false);
