...
{
    /// <summary>
    /// Manages a shared pointer to a memory pool. Microsoft SIGMA uses memory pools for
    ...
    /// Microsoft SIGMA provides overloads of the functions that take a MemoryPoolHandle as an
