...
using Microsoft.Research.SIGMA.Tools;
using System;
using System.Text;
...
namespace Microsoft.Research.SIGMA
{
    ...
    /// constructor of SIGMAContext. The properties KeyContextData and KeyParmsId return the
    ...
    public class SIGMAContext : NativeObject
    {
        /// <summary>
        ...
        public SIGMAContext(EncryptionParameters parms,
            bool expandModChain = true, SecLevelType secLevel = SecLevelType.TC128)
        {
            if (null == parms)
                throw new ArgumentNullException(nameof(parms));

            NativeMethods.SIGMAContext_Create(parms.NativePtr,
        ...
        public ContextData GetContextData(ParmsId parmsId)
        {
            ...
            NativeMethods.SIGMAContext_GetContextData(NativePtr, parmsId.Block, out IntPtr contextData);
        ...
        public ContextData KeyContextData
        {
            get
            {
                NativeMethods.SIGMAContext_KeyContextData(NativePtr, out IntPtr contextData);
                ContextData data = new ContextData(contextData, owned: false);
                return data;
            }
        }
        ...
        public ContextData FirstContextData
        {
            get
            {
                NativeMethods.SIGMAContext_FirstContextData(NativePtr, out IntPtr contextData);
                ContextData data = new ContextData(contextData, owned: false);
                return data;
            }
        }
        ...
        public ContextData LastContextData
        {
            get
            {
                NativeMethods.SIGMAContext_LastContextData(NativePtr, out IntPtr contextData);
                ContextData data = new ContextData(contextData, owned: false);
                return data;
            }
        }
        ...
        public bool ParametersSet
        {
            get
            {
                NativeMethods.SIGMAContext_ParametersSet(NativePtr, out bool paramsSet);
                return paramsSet;
            }
        }

        /// <summary>
        /// If the encryption parameters are set in a way that is considered valid by SIGMA, return "success".
        ...
        {
            NativeMethods.SIGMAContext_ParameterErrorName(NativePtr, null, out ulong length);
            byte[] buffer = new byte[length];
            NativeMethods.SIGMAContext_ParameterErrorName(NativePtr, buffer, out length);
            return Encoding.ASCII.GetString(buffer);
        }

        /// <summary>
        /// If the encryption parameters are set in a way that is considered valid by SIGMA, return "valid".
        /// Otherwise, return a comprehensive reason.
        /// </summary>
        public string ParameterErrorMessage()
        {
            NativeMethods.SIGMAContext_ParameterErrorMessage(NativePtr, null, out ulong length);
            byte[] buffer = new byte[length];
            NativeMethods.SIGMAContext_ParameterErrorMessage(NativePtr, buffer, out length);
            return Encoding.ASCII.GetString(buffer);
        }
        ...
        public ParmsId KeyParmsId
        {
            get
            {
                ...
                NativeMethods.SIGMAContext_KeyParmsId(NativePtr, parms.Block);
                return parms;
            }
        }
        ...
        public ParmsId FirstParmsId
        {
            ...
            {
                ParmsId parms = new ParmsId();
                NativeMethods.SIGMAContext_FirstParmsId(NativePtr, parms.Block);
                return parms;
            }
        }
        ...
        public ParmsId LastParmsId
        {
            ...
            {
                ParmsId parms = new ParmsId();
                NativeMethods.SIGMAContext_LastParmsId(NativePtr, parms.Block);
                return parms;
            }
        }
        ...
        public bool UsingKeyswitching
        {
            get
            {
                NativeMethods.SIGMAContext_UsingKeyswitching(NativePtr, out bool result);
                return result;
            }
        }
        ...
        {
            NativeMethods.SIGMAContext_Destroy(NativePtr);
        }
