...
namespace Microsoft.Research.SIGMA
{
        ...
        ISettable<Ciphertext>
    {
        ...
        /// <exception cref="ArgumentException">if pool is uninitialized</exception>
        public Ciphertext(SIGMAContext context, ParmsId parmsId, MemoryPoolHandle pool = null)
        {
            if (null == context)
                throw new ArgumentNullException(nameof(context));
            if (null == parmsId)
        ...
        /// <exception cref="ArgumentException">if pool is uninitialized</exception>
        public Ciphertext(SIGMAContext context, ParmsId parmsId, ulong sizeCapacity,
        ...
        /// parameters</exception>
        /// <exception cref="ArgumentException">if sizeCapacity is less than 2 or too large</exception>
        public void Reserve(SIGMAContext context, ParmsId parmsId, ulong sizeCapacity)
        {
            if (null == context)
                throw new ArgumentNullException(nameof(context));
            if (null == parmsId)
        ...
        /// <exception cref="ArgumentException">if the encryption parameters are not valid</exception>
        /// <exception cref="ArgumentException">if sizeCapacity is less than 2 or too large</exception>
        public void Reserve(SIGMAContext context, ulong sizeCapacity)
        {
            if (null == context)
                throw new ArgumentNullException(nameof(context));
        ...
        /// determined by the given SIGMAContext and parmsId.
        ///
        ...
        public void Resize(SIGMAContext context, ParmsId parmsId, ulong size)
        {
            if (null == context)
                throw new ArgumentNullException(nameof(context));
            if (null == parmsId)
        ...
        /// <exception cref="ArgumentException">if the encryption parameters are not valid</exception>
        /// <exception cref="ArgumentException">if size is less than 2 or too large</exception>
        public void Resize(SIGMAContext context, ulong size)
        {
            if (null == context)
                throw new ArgumentNullException(nameof(context));
        ...
        /// by this version of Microsoft SIGMA, if the loaded data is invalid, or if the
        /// loaded compression mode is not supported</exception>
        public long UnsafeLoad(SIGMAContext context, Stream stream)
        {
            if (null == context)
                throw new ArgumentNullException(nameof(context));
        ...
        /// by this version of Microsoft SIGMA, if the loaded data is invalid, or if the
        /// loaded compression mode is not supported</exception>
        public long Load(SIGMAContext context, Stream stream)
        {
            if (null == context)
                throw new ArgumentNullException(nameof(context));
