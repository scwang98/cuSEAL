...
namespace Microsoft.Research.SIGMA
{
    ...
    public abstract class Serialization
    {
        ...
        /// <summary>The magic value indicating a Microsoft SIGMA header.</summary>
        public static readonly ushort SIGMAMagic = ((Func<ushort>)(() => {
            NativeMethods.Serialization_SIGMAMagic(out ushort sigmaMagic);
            return sigmaMagic;
        }))();

        /// <summary>The size in bytes of the SIGMAHeader.</summary>
        public static readonly byte SIGMAHeaderSize = ((Func<byte>)(() => {
            NativeMethods.Serialization_SIGMAHeaderSize(out byte sigmaHeaderSize);
            return sigmaHeaderSize;
        }))();
        ...
        public class SIGMAHeader : ISettable<SIGMAHeader>
        {
            /// <summary>A magic number identifying this is a SIGMAHeader struct (2 bytes)</summary>
            [FieldOffset(0)]public ushort Magic = SIGMAMagic;

            /// <summary>Size in bytes of the SIGMAHeader struct (1 byte)</summary>
            [FieldOffset(2)]public byte HeaderSize = SIGMAHeaderSize;

            /// <summary>Microsoft SIGMA's major version number (1 byte)</summary>
            [FieldOffset(3)]public byte VersionMajor = SIGMAVersion.Major;

            /// <summary>Microsoft SIGMA's minor version number (1 byte)</summary>
            [FieldOffset(4)]public byte VersionMinor = SIGMAVersion.Minor;
            ...
            /// <summary>
            /// Copies a given SIGMAHeader to the current one.
            /// </summary>
            /// <param name="assign">The SIGMAHeader to copy from</param>
            /// <exception cref="ArgumentNullException">if assign is null</exception>
            public void Set(SIGMAHeader assign)
            {
                if (null == assign)
        ...
        /// <summary>Returns true if the SIGMAHeader has a version number compatible with this version of
        /// Microsoft SIGMA.</summary>
        /// <param name="header">The SIGMAHeader</param>
        public static bool IsCompatibleVersion(SIGMAHeader header)
        {
            byte[] headerArray = new byte[SIGMAHeaderSize];
        ...
        /// <summary>Returns true if the given SIGMAHeader is valid for this version of Microsoft SIGMA.</summary>
        /// <param name="header">The SIGMAHeader</param>
        public static bool IsValidHeader(SIGMAHeader header)
        {
            byte[] headerArray = new byte[SIGMAHeaderSize];
            using (MemoryStream stream = new MemoryStream(headerArray))
            {
        ...
        /// <summary>Saves a SIGMAHeader to a given binary stream.</summary>
        /// <remarks>
        /// Saves a SIGMAHeader to a given stream. The output is in binary format and not human-readable.
        /// </remarks>
        /// <param name="header">The SIGMAHeader to save to the stream</param>
        /// <param name="stream">The stream to save the SIGMAHeader to</param>
        ...
        public static void SaveHeader(SIGMAHeader header, Stream stream)
        {
            if (null == header)
        ...
        /// <summary>Loads a SIGMAHeader from a given stream.</summary>
        /// <param name="stream">The stream to load the SIGMAHeader from</param>
        /// <param name="header">The SIGMAHeader to populate with the loaded data</param>
        /// <param name="tryUpgradeIfInvalid">If the loaded SIGMAHeader is invalid, attempt to identify its format and
        /// upgrade to the current SIGMAHeader version</param>
        /// <exception cref="ArgumentNullException">if header or stream is null</exception>
        /// <exception cref="ArgumentException">if the stream is closed or does not support reading</exception>
        /// <exception cref="InvalidOperationException">if the loaded data is not a valid SIGMAHeader or if the loaded
        ...
        /// <exception cref="IOException">if I/O operations failed</exception>
        public static void LoadHeader(Stream stream, SIGMAHeader header, bool tryUpgradeIfInvalid = true)
        {
            if (null == header)
                throw new ArgumentNullException(nameof(header));
            if (null == stream)
            ...
            if (tryUpgradeIfInvalid && !IsValidHeader(header))
            {
                ...
                LegacyHeaders.SIGMAHeader_3_4 header_3_4 = new LegacyHeaders.SIGMAHeader_3_4(header);

                SIGMAHeader newHeader = new SIGMAHeader();
        ...
        /// <remarks>
        /// This function calls the <see cref="LoadHeader" /> function to first load a <see cref="SIGMAHeader" /> object
        /// from <paramref name="stream"/>. The <see cref="SIGMAHeader.Size"/> is then read from the
        /// <see cref="SIGMAHeader" /> and a buffer of corresponding size is allocated. Next, the buffer is filled with
        ...
        internal static long Load(LoadDelegate LoadData, Stream stream)
        {
            ...
            try
            {
                ...
                if (!IsValidHeader(header))
                    throw new InvalidOperationException("Loaded SIGMAHeader is invalid");
            ...
            {
                throw new InvalidOperationException("Size indicated by loaded SIGMAHeader is out of bounds", ex);
            }
        }
    }
    ...
    {
        /// <summary>Class to enable compatibility with Microsoft SIGMA 3.4 headers.</summary>
        [StructLayout(LayoutKind.Explicit, Size=16)]
        public class SIGMAHeader_3_4 : ISettable<SIGMAHeader_3_4>, ISettable<Serialization.SIGMAHeader>
        {
            /// <summary>SIGMAMagic</summary>
            [FieldOffset(0)]public ushort Magic = Serialization.SIGMAMagic;
            ...
            /// <summary>Creates a new SIGMAHeader_3_4.</summary>
            public SIGMAHeader_3_4()
            {
            }

            /// <summary>
            /// Constructs a new SIGMAHeader_3_4 by copying a given one.
            /// </summary>
            /// <param name="copy">The SIGMAHeader_3_4 to copy from</param>
            /// <exception cref="ArgumentNullException">if copy is null</exception>
            public SIGMAHeader_3_4(Serialization.SIGMAHeader copy)
            {
                if (null == copy)
            ...
            /// <summary>Copies a given SIGMAHeader_3_4 to the current one.</summary>
            /// <param name="assign">The SIGMAHeader_3_4 to copy from</param>
            /// <exception cref="ArgumentNullException">if assign is null</exception>
            public void Set(SIGMAHeader_3_4 assign)
            {
                if (null == assign)
                    throw new ArgumentNullException(nameof(assign));
            ...
            /// <summary>Copies a given SIGMAHeader to the current one as a byte array.</summary>
            /// <param name="assign">The SIGMAHeader to copy from</param>
            /// <exception cref="ArgumentNullException">if assign is null</exception>
            public void Set(Serialization.SIGMAHeader assign)
            {
                if (null == assign)
                    throw new ArgumentNullException(nameof(assign));
