...
namespace Microsoft.Research.SIGMA
{
    ...
    /// The qualifiers are automatically created by the <see cref="SIGMAContext" />
    ...
    public class EncryptionParameterQualifiers : NativeObject
    {
        ...
        /// <summary>
        /// If the encryption parameters are set in a way that is considered valid by SIGMA,
        ...
        /// variable UsingFFT will be set to true. However, currently Microsoft SIGMA requires this
        ...
        /// currently Microsoft SIGMA requires this to be the case for the parameters to be valid.
