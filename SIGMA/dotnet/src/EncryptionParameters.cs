...
namespace Microsoft.Research.SIGMA
{
    ...
    /// can be used to create an instance of the <see cref="SIGMAContext" /> class,
    ...
    /// through the <see cref="SIGMAContext.ContextData" /> class once the SIGMAContext
    /// has been created.
    /// </para>
    /// <para>
    ...
    public class EncryptionParameters : NativeObject, IEquatable<EncryptionParameters>
    {
        ...
        /// the scheme (bigger is worse), and the security level(bigger is better). In SIGMA
        ...
        ///     security level (bigger is worse). In Microsoft SIGMA each of the prime numbers in
        ...
        ///     amount of computation that the scheme can perform (bigger is worse). In Microsoft SIGMA
        ...
        /// Microsoft SIGMA the plaintext modulus can be at most 60 bits long, but can otherwise
