...
namespace Microsoft.Research.SIGMA
{
    ...
    {
#if SIGMA_IOS
        private const string sigmac = "__Internal";
#else
        private const string sigmac = "sigmac";
#endif

#region Version methods

        [DllImport(sigmac, PreserveSig = false)]
...
#region EncryptionParameterQualifiers methods
        ...
        [DllImport(sigmac, PreserveSig = false, CharSet = CharSet.Ansi)]
...
#region Modulus methods
        ...
        [DllImport(sigmac, EntryPoint = "Modulus_Create1", PreserveSig = false)]
        internal static extern void Modulus_Create(ulong value, out IntPtr smallModulus);

        [DllImport(sigmac, EntryPoint = "Modulus_Create2", PreserveSig = false)]
        ...
        [DllImport(sigmac, EntryPoint = "Modulus_Set1", PreserveSig = false)]
        internal static extern void Modulus_Set(IntPtr thisptr, IntPtr assign);

        [DllImport(sigmac, EntryPoint = "Modulus_Set2", PreserveSig = false)]
        ...
        [DllImport(sigmac, EntryPoint = "Modulus_Equals1", PreserveSig = false)]
        internal static extern void Modulus_Equals(IntPtr thisptr, IntPtr other, out bool result);

        [DllImport(sigmac, EntryPoint = "Modulus_Equals2", PreserveSig = false)]
...
#region EncryptionParameters methods
        ...
        [DllImport(sigmac, EntryPoint = "EncParams_Create1", PreserveSig = false)]
        internal static extern void EncParams_Create(byte scheme, out IntPtr encParams);

        [DllImport(sigmac, EntryPoint = "EncParams_Create2", PreserveSig = false)]
        ...
        [DllImport(sigmac, EntryPoint = "EncParams_SetPlainModulus1", PreserveSig = false)]
        internal static extern void EncParams_SetPlainModulus(IntPtr thisptr, IntPtr plainModulus);

        [DllImport(sigmac, EntryPoint = "EncParams_SetPlainModulus2", PreserveSig = false)]
...
#region CoeffModulus methods
        ...
        [DllImport(sigmac, EntryPoint = "CoeffModulus_Create1", PreserveSig = false)]
        ...
        [DllImport(sigmac, EntryPoint = "CoeffModulus_Create2", PreserveSig = false)]
        internal static extern void CoeffModulus_Create(
            ulong polyModulusDegree,
            ulong length,
            int[] bitSizes,
...
#region SIGMAContext methods

        [DllImport(sigmac, PreserveSig = false)]
        internal static extern void SIGMAContext_Create(
        ...
        [DllImport(sigmac, PreserveSig = false)]
        internal static extern void SIGMAContext_Destroy(IntPtr thisptr);

        [DllImport(sigmac, PreserveSig = false)]
        internal static extern void SIGMAContext_KeyParmsId(IntPtr thisptr, ulong[] parmsId);

        [DllImport(sigmac, PreserveSig = false)]
        internal static extern void SIGMAContext_FirstParmsId(IntPtr thisptr, ulong[] parmsId);

        [DllImport(sigmac, PreserveSig = false)]
        internal static extern void SIGMAContext_LastParmsId(IntPtr thisptr, ulong[] parmsId);

        [DllImport(sigmac, PreserveSig = false)]
        internal static extern void SIGMAContext_ParametersSet(IntPtr thisptr, out bool paramsSet);

        [DllImport(sigmac, PreserveSig = false)]
        internal static extern void SIGMAContext_ParameterErrorName(IntPtr thisptr, byte[] outstr, out ulong length);

        [DllImport(sigmac, PreserveSig = false)]
        internal static extern void SIGMAContext_ParameterErrorMessage(IntPtr thisptr, byte[] outstr, out ulong length);

        [DllImport(sigmac, PreserveSig = false)]
        internal static extern void SIGMAContext_KeyContextData(IntPtr thisptr, out IntPtr contextData);

        [DllImport(sigmac, PreserveSig = false)]
        internal static extern void SIGMAContext_FirstContextData(IntPtr thisptr, out IntPtr contextData);

        [DllImport(sigmac, PreserveSig = false)]
        internal static extern void SIGMAContext_LastContextData(IntPtr thisptr, out IntPtr contextData);

        [DllImport(sigmac, PreserveSig = false)]
        internal static extern void SIGMAContext_GetContextData(IntPtr thisptr, ulong[] parmsId, out IntPtr contextData);

        [DllImport(sigmac, PreserveSig = false)]
        internal static extern void SIGMAContext_UsingKeyswitching(IntPtr thisptr, out bool usingKeySwitching);
...
#region Evaluator methods
        ...
        [DllImport(sigmac, PreserveSig = false)]
        internal static extern void Evaluator_Create(IntPtr sigmaContext, out IntPtr evaluator);
        ...
        [DllImport(sigmac, EntryPoint = "Evaluator_ModSwitchToNext1", PreserveSig = false)]
        internal static extern void Evaluator_ModSwitchToNext(IntPtr thisptr, IntPtr encrypted, IntPtr destination, IntPtr pool);

        [DllImport(sigmac, EntryPoint = "Evaluator_ModSwitchTo1", PreserveSig = false)]
        ...
        [DllImport(sigmac, EntryPoint = "Evaluator_ModSwitchToNext2", PreserveSig = false)]
        internal static extern void Evaluator_ModSwitchToNext(IntPtr thisptr, IntPtr plain, IntPtr destination);

        [DllImport(sigmac, EntryPoint = "Evaluator_ModSwitchTo2", PreserveSig = false)]
        ...
        [DllImport(sigmac, EntryPoint = "Evaluator_ModReduceToNext", PreserveSig = false)]
        internal static extern void Evaluator_ModReduceToNext(IntPtr thisptr, IntPtr encrypted, IntPtr destination, IntPtr pool);

        [DllImport(sigmac, EntryPoint = "Evaluator_ModReduceTo", PreserveSig = false)]
        ...
        [DllImport(sigmac, EntryPoint = "Evaluator_TransformToNTT1", PreserveSig = false)]
        ...
        [DllImport(sigmac, EntryPoint = "Evaluator_TransformToNTT2", PreserveSig = false)]
...
#region Plaintext methods
        ...
        [DllImport(sigmac, EntryPoint = "Plaintext_Set1", PreserveSig = false)]
        internal static extern void Plaintext_Set(IntPtr thisptr, IntPtr assign);

        [DllImport(sigmac, EntryPoint = "Plaintext_Set2", PreserveSig = false, CharSet = CharSet.Ansi)]
        internal static extern void Plaintext_Set(IntPtr thisptr, string hexPoly);

        [DllImport(sigmac, EntryPoint = "Plaintext_Set3", PreserveSig = false)]
        internal static extern void Plaintext_Set(IntPtr thisptr, ulong constCoeff);

        [DllImport(sigmac, EntryPoint = "Plaintext_Set4", PreserveSig = false)]
        ...
        [DllImport(sigmac, EntryPoint = "Plaintext_SetZero1", PreserveSig = false)]
        internal static extern void Plaintext_SetZero(IntPtr thisptr);

        [DllImport(sigmac, EntryPoint = "Plaintext_SetZero2", PreserveSig = false)]
        internal static extern void Plaintext_SetZero(IntPtr thisptr, ulong startCoeff);

        [DllImport(sigmac, EntryPoint = "Plaintext_SetZero3", PreserveSig = false)]
...
#region KSwitchKeys methods
        ...
        [DllImport(sigmac, EntryPoint = "KSwitchKeys_Create1", PreserveSig = false)]
        internal static extern void KSwitchKeys_Create(out IntPtr kswitchKeys);

        [DllImport(sigmac, EntryPoint = "KSwitchKeys_Create2", PreserveSig = false)]
...
#region GaloisKeys methods
        ...
        [DllImport(sigmac, EntryPoint = "GaloisKeys_GetIndex", PreserveSig = false)]
...
#region KeyGenerator methods
        ...
        [DllImport(sigmac, EntryPoint = "KeyGenerator_Create1", PreserveSig = false)]
        internal static extern void KeyGenerator_Create(IntPtr sigmaContext, out IntPtr keyGenerator);

        [DllImport(sigmac, EntryPoint = "KeyGenerator_Create2", PreserveSig = false)]
        internal static extern void KeyGenerator_Create(IntPtr sigmaContext, IntPtr secretKey, out IntPtr keyGenerator);
...
#region RelinKeys methods
        ...
        [DllImport(sigmac, EntryPoint = "RelinKeys_GetIndex", PreserveSig = false)]
...
#region PublicKey methods
        ...
        [DllImport(sigmac, EntryPoint = "PublicKey_Create1", PreserveSig = false)]
        internal static extern void PublicKey_Create(out IntPtr publicKey);

        [DllImport(sigmac, EntryPoint = "PublicKey_Create2", PreserveSig = false)]
...
#region SecretKey methods
        ...
        [DllImport(sigmac, EntryPoint = "SecretKey_Create1", PreserveSig = false)]
        internal static extern void SecretKey_Create(out IntPtr secretKey);

        [DllImport(sigmac, EntryPoint = "SecretKey_Create2", PreserveSig = false)]
...
#region MemoryManager methods
        ...
        [DllImport(sigmac, EntryPoint = "MemoryManager_GetPool1", PreserveSig = false)]
        internal static extern void MemoryManager_GetPool(int profOpt, bool clearOnDestruction, out IntPtr handle);

        [DllImport(sigmac, EntryPoint = "MemoryManager_GetPool2", PreserveSig = false)]
...
#region MemoryPoolHandle methods
        ...
        [DllImport(sigmac, EntryPoint = "MemoryPoolHandle_Create1", PreserveSig = false)]
        internal static extern void MemoryPoolHandle_Create(out IntPtr handlePtr);

        [DllImport(sigmac, EntryPoint = "MemoryPoolHandle_Create2", PreserveSig = false)]
...
#region CKKSEncoder methods
        ...
        [DllImport(sigmac, EntryPoint = "CKKSEncoder_Encode1", PreserveSig = false)]
        ...
        [DllImport(sigmac, EntryPoint = "CKKSEncoder_Encode2", PreserveSig = false)]
        ...
        [DllImport(sigmac, EntryPoint = "CKKSEncoder_Encode3", PreserveSig = false)]
        ...
        [DllImport(sigmac, EntryPoint = "CKKSEncoder_Encode4", PreserveSig = false)]
        ...
        [DllImport(sigmac, EntryPoint = "CKKSEncoder_Encode5", PreserveSig = false)]
        internal static extern void CKKSEncoder_Encode(IntPtr thisptr, long value, ulong[] parms_id, IntPtr destination);

        [DllImport(sigmac, EntryPoint = "CKKSEncoder_Decode1", PreserveSig = false)]
        ...
        [DllImport(sigmac, EntryPoint = "CKKSEncoder_Decode2", PreserveSig = false)]
...
#region BatchEncoder methods
        ...
        [DllImport(sigmac, EntryPoint = "BatchEncoder_Decode2", PreserveSig = false)]
...
#region Serialization methods
        ...
        [DllImport(sigmac, PreserveSig = false)]
        internal static extern void Serialization_SIGMAMagic(out ushort result);

        [DllImport(sigmac, PreserveSig = false)]
        internal static extern void Serialization_SIGMAHeaderSize(out byte result);
