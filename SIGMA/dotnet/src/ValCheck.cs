...
namespace Microsoft.Research.SIGMA
{
    ...
    public static class ValCheck
    {
        ...
        public static bool IsValidFor(Plaintext plaintext, SIGMAContext context)
        {
            if (null == plaintext)
        ...
        public static bool IsValidFor(Ciphertext ciphertext, SIGMAContext context)
        {
            if (null == ciphertext)
        ...
        public static bool IsValidFor(SecretKey secretKey, SIGMAContext context)
        {
            if (null == secretKey)
        ...
        public static bool IsValidFor(PublicKey publicKey, SIGMAContext context)
        {
            if (null == publicKey)
        ...
        public static bool IsValidFor(KSwitchKeys kswitchKeys, SIGMAContext context)
        {
            if (null == kswitchKeys)
        ...
        public static bool IsValidFor(RelinKeys relinKeys, SIGMAContext context)
        {
            if (null == relinKeys)
        ...
        public static bool IsValidFor(GaloisKeys galoisKeys, SIGMAContext context)
        {
            if (null == galoisKeys)
