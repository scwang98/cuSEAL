...
namespace Microsoft.Research.SIGMA
{
    ...
    public class CKKSEncoder : NativeObject
    {
        ...
        public CKKSEncoder(SIGMAContext context)
        {
            if (null == context)
            ...
            SIGMAContext.ContextData contextData = context.FirstContextData;
        ...
        /// <summary>
        /// SIGMAContext for this encoder
        /// </summary>
        private readonly SIGMAContext context_ = null;
