...
namespace Microsoft.Research.SIGMA
{
    ...
    public class KeyGenerator : NativeObject
    {
        ...
        /// </summary>
        /// <remarks>
        /// Creates a KeyGenerator initialized with the specified <see cref="SIGMAContext" />.
        ...
        public KeyGenerator(SIGMAContext context)
        {
            if (null == context)
        ...
        /// SIGMAContext and specified previously secret key.
        /// </summary>
        /// <remarks>
        /// Creates an KeyGenerator instance initialized with the specified
        /// SIGMAContext and specified previously secret key. This can e.g. be used
        ...
        public KeyGenerator(SIGMAContext context, SecretKey secretKey)
        {
            if (null == context)
                throw new ArgumentNullException(nameof(context));
            if (null == secretKey)
