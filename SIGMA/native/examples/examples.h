...
/*
Helper function: Prints the parameters in a SIGMAContext.
*/
inline void print_parameters(const sigma::SIGMAContext &context)
{
    ...
    */
    ...
    {
    case sigma::scheme_type::bfv:
        scheme_name = "BFV";
        break;
    case sigma::scheme_type::ckks:
        scheme_name = "CKKS";
        break;
    case sigma::scheme_type::bgv:
        scheme_name = "BGV";
        break;
    default:
    ...
    */
    if (context_data.parms().scheme() == sigma::scheme_type::bfv)
    {
...
*/
inline std::ostream &operator<<(std::ostream &stream, sigma::parms_id_type parms_id)
{
    /*
...
{
    return sigma::util::uint_to_hex_string(&value, std::size_t(1));
}
