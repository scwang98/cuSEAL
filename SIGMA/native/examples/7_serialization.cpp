...
/*
In this example we show how serialization works in Microsoft SIGMA. Specifically,
...
void example_serialization()
{
    ...
    */
#if (!defined(SIGMA_USE_ZSTD) && !defined(SIGMA_USE_ZLIB))
    ...
    Microsoft SIGMA objects consist of two parts, one of which is pseudorandom data
    ...
    Only some Microsoft SIGMA objects are seedable. Specifically, they are:
    ...
    be beneficial to use Microsoft SIGMA in secret-key mode whenever the public
    ...
    */
    ...
    It is critical to note that all data serialized by Microsoft SIGMA is in binary
    ...
    */
    {
        ...
        */
        ...
        If Microsoft SIGMA is compiled with Zstandard or ZLIB support, the default
        ...
        */
        ...
        buffer.
        */
        vector<sigma_byte> byte_buffer(static_cast<size_t>(parms.save_size()));
        parms.save(reinterpret_cast<sigma_byte *>(byte_buffer.data()), byte_buffer.size());
        ...
        */
        ...
        parms2.load(reinterpret_cast<const sigma_byte *>(byte_buffer.data()), byte_buffer.size());
        ...
        */
        ...
        /*
        The functions presented and used here exist for all Microsoft SIGMA objects
    ...
    /*
    Client starts by loading the encryption parameters, sets up the SIGMAContext,
    ...
    */
    {
        ...
        */
        ...
        to use the default, as determined by the Microsoft SIGMA build system.
        */
        ...
        */
        ...
        serialize multiple Microsoft SIGMA objects sequentially in a stream. Each
    ...
    SIGMAContext and set up an Evaluator here.
    */
    {
        EncryptionParameters parms;
        parms.load(parms_stream);
    ...
    */
    ...
    serialized by Microsoft SIGMA. Serialized data always starts with a 16-byte
    SIGMAHeader struct, as defined in native/src/sigma/serialization.h, and is
    followed by the possibly compressed data for the object.

    A SIGMAHeader contains the following data:

        [offset 0] 2-byte magic number 0xA15E (Serialization::sigma_magic)
        [offset 2] 1-byte indicating the header size in bytes (always 16)
        [offset 3] 1-byte indicating the Microsoft SIGMA major version number
        [offset 4] 1-byte indicating the Microsoft SIGMA minor version number
    ...
    Currently Microsoft SIGMA supports only little-endian systems.

    As an example, we demonstrate the SIGMAHeader created by saving a plaintext.
    Note that the SIGMAHeader is never compressed, so there is no need to specify
    ...
    */
    ...
    /*
    We can now load just the SIGMAHeader back from the stream as follows.
    */
    ...
    indicated by the SIGMAHeader.
    */
    print_line(__LINE__);
    cout << "Size written to stream: " << data_size << " bytes" << endl;
    cout << "             "
         << "Size indicated in SIGMAHeader: " << header.size << " bytes" << endl;
    cout << endl;
#endif
}
