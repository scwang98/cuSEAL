...
void example_levels()
{
    ...
    */
    ...
    some of the most important levels:
        ...
        SIGMAContext::key_context_data(): access to key level ContextData
        SIGMAContext::first_context_data(): access to highest data level ContextData
        SIGMAContext::last_context_data(): access to lowest level ContextData
    ...
    */
    context = SIGMAContext(parms, false);
