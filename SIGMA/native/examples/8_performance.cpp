...
void bfv_performance_test(SIGMAContext context)
{
    ...
    */
    ...
    for (size_t i = 0; i < static_cast<size_t>(count); i++)
    {
        ...
        */
        ...
        vector<sigma_byte> buf(buf_size);
        time_start = chrono::high_resolution_clock::now();
...
void ckks_performance_test(SIGMAContext context)
{
    chrono::high_resolution_clock::time_point time_start, time_end;
...
void bgv_performance_test(SIGMAContext context)
{
    chrono::high_resolution_clock::time_point time_start, time_end;
