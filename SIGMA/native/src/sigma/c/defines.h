...
#if defined(SIGMA_C_EXPORTS) || defined(sigma_c_EXPORTS) || defined(sigmac_EXPORTS)
#define SIGMA_C_DECOR extern "C" __declspec(dllexport)
#else
#define SIGMA_C_DECOR extern "C" __declspec(dllimport)
#endif

#define SIGMA_C_CALL __cdecl

#else // _MSC_VER

#define SIGMA_C_DECOR extern "C"
#define SIGMA_C_CALL
...
#define SIGMA_C_FUNC SIGMA_C_DECOR HRESULT SIGMA_C_CALL
