...
namespace sigma::util {
    ...
    public:
        ...
        CUNTTTables(CUNTTTables &&source) = default;

        // This construction should be down on host.
        CUNTTTables(const NTTTables &copy)
        ...
        CUNTTTables &operator=(CUNTTTables &&assign) = default;

    private:
        CUNTTTables &operator=(const CUNTTTables &assign) = delete;
