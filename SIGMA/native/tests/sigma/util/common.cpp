...
namespace sigmatest
{
    namespace util
    {
        ...
        TEST(Common, SafeArithmetic)
        {
            ...
            unsigned long long pos_ull_max = 0xFFFFFFFFFFFFFFFF;
            long long neg_ull = -1;
            SIGMA_MAYBE_UNUSED unsigned long long res_ul;
            SIGMA_MAYBE_UNUSED long long res_l;
        ...
        TEST(Common, ReverseBits32)
        {
            ...
            SIGMA_IF_CONSTEXPR(sizeof(unsigned) == 4)
            ReverseBits32Helper<unsigned>();

            SIGMA_IF_CONSTEXPR(sizeof(unsigned long) == 4)
            ReverseBits32Helper<unsigned long>();

            SIGMA_IF_CONSTEXPR(sizeof(unsigned long long) == 4)
            ReverseBits32Helper<unsigned long long>();

            SIGMA_IF_CONSTEXPR(sizeof(size_t) == 4)
        ...
        TEST(Common, ReverseBits64)
        {
            ...
            // Other types
#ifdef SIGMA_USE_IF_CONSTEXPR
            SIGMA_IF_CONSTEXPR(sizeof(unsigned) == 8)
            ReverseBits64Helper<unsigned>();

            SIGMA_IF_CONSTEXPR(sizeof(unsigned long) == 8)
            ReverseBits64Helper<unsigned long>();

            SIGMA_IF_CONSTEXPR(sizeof(unsigned long long) == 8)
            ReverseBits64Helper<unsigned long long>();

            SIGMA_IF_CONSTEXPR(sizeof(size_t) == 8)
