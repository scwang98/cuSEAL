...
#include "sigma/util/uintarithmod.h"
    ...
    namespace util
    {
        ...
        TEST(RNSToolTest, MontgomeryReduction)
        {
            ...
            Pointer<RNSTool> rns_tool;
            {
                ...
                // m_tilde is always smaller than the primes in Bsk (SIGMA_INTERNAL_MOD_BIT_COUNT (61) bits).
...
#if !defined(SIGMA_DEBUG) || !defined(SIGMA_USE_INTEL_HEXL)
            in[0] = 35;
            in[1] = 70;
            in[2] = 35;
            in[3] = 70;
