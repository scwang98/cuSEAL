...
namespace sigmatest
{
    TEST(ContextTest, BFVContextConstructor)
    {
        ...
        parms.set_random_generator(nullptr);
        {
            SIGMAContext context(parms, false, sec_level_type::tc128);
            auto qualifiers = context.first_context_data()->qualifiers();
            ASSERT_FALSE(qualifiers.parameters_set());
    ...
    {
        {
            ...
            parms.set_plain_modulus(73);
            SIGMAContext context(parms, true, sec_level_type::none);
            ...
            context = SIGMAContext(parms, false, sec_level_type::none);
